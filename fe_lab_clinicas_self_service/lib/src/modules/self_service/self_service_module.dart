...
import 'package:fe_lab_clinicas_self_service/src/repositories/documents/information_form/information_form_repository.dart';
import 'package:fe_lab_clinicas_self_service/src/repositories/documents/information_form/information_form_repository_impl.dart';
...
class SelfServiceModule extends FlutterGetItModule {
  ...
  Map<String, WidgetBuilder> get pages => {
        ...
        '/who_i_am': (context) => const WhoIAmPage(),
        '/find_patient': (context) => const FindPatientRouter(),
